...
def main() -> None:
    data_cins = pandas.read_csv('africa_cins.csv', usecols=['country', 'short_name', 'CINS']).set_index(['short_name'])
    data_coniq_comcol_dist = pandas.read_excel('dist_cepii.xls').set_index(['iso_o', 'iso_d'])
